...
export const ayodhyaMandirKanda: KandaSection = {
  ...
  heroImage: '/assets/bg_temple.jpg',
  backgroundImage: '/assets/bg_temple.jpg',
  characters: [
    { name: 'Ram Lalla', role: 'Divine Idol', status: 'active', portrait: '/assets/ram_lalla_shringaar.jpg', description: 'The 51-inch black stone idol of Lord Ram as a child — serene, joyous, standing on a lotus pedestal in the Garbhagriha.' },
  ],
  locations: [
    { name: 'Shri Ram Janmabhoomi Teerth Kshetra', description: 'The sacred birthplace temple complex. 392 pillars, 5 mandapas, 70 acres.', realWorld: 'Ayodhya, Uttar Pradesh, India', image: '/assets/bg_temple.jpg' },
    { name: 'Saryu River Ghats', description: 'The ancient sacred river and its ghats — site of the annual Deepotsav.', realWorld: 'Ayodhya, Uttar Pradesh, India', image: '/assets/ayodhya_gate_bg.jpg' },
  ],
  weapons: [],
  dialogues: [
  ...
  gallery: [
    { image: '/assets/ram_lalla_shringaar.jpg', caption: 'Ram Lalla in Vaidika Shringaar' },
    { image: '/assets/ram_lalla_saffron.jpg', caption: 'Ram Lalla in Peetambara Saffron' },
    { image: '/assets/ram_lalla_flowers.jpg', caption: 'Ram Lalla adorned in Pushpa Shringaar' },
    { image: '/assets/ram_lalla_lotus.jpg', caption: 'Ram Lalla on the divine Lotus Pedestal' },
    { image: '/assets/ram_lalla_yellow.jpg', caption: 'Ram Lalla in Swarna Yellow robes' },
    { image: '/assets/ram_lalla_abhisheka_milk.jpg', caption: 'Ksheera Abhishekam at dawn' },
    { image: '/assets/ram_lalla_abhisheka_paste.jpg', caption: 'Chandan Abhishekam of Ram Lalla' },
    { image: '/assets/ram_lalla_blue.jpg', caption: 'Ram Lalla in Neela Peetambara blue robes' },
    { image: '/assets/ram_lalla_closeup.jpg', caption: 'Close up of the divine child-god smile' },
    { image: '/assets/ram_lalla_cream.jpg', caption: 'Ram Lalla in Swarna Cream robes' },
    { image: '/assets/ram_lalla_magenta.jpg', caption: 'Ram Lalla in Magenta Shringaar' },
    { image: '/assets/ram_lalla_pink.jpg', caption: 'Ram Lalla in Taruna Pink robes' },
  ],
  facts: [
  ...
  events: [
    {
      ...
      media: { hero: '/assets/ayodhya_gate_bg.jpg', background: '/assets/ayodhya_gate_bg.jpg', parallaxFg: '/assets/ayodhya_gate_fg.jpg', parallaxMid: '/assets/ayodhya_gate_mid.jpg' },
    ...
    },
    {
      ...
      characters: ['Ram'],
      media: { hero: '/assets/bg_temple.jpg', background: '/assets/bg_temple.jpg' },
    },
    {
      id: 'garbhagriha',
      ...
      characters: ['Ram'],
      media: { hero: '/assets/ram_lalla_shringaar.jpg', background: '/assets/bg_temple.jpg', thumbnail: '/assets/ram_lalla_closeup.jpg' },
